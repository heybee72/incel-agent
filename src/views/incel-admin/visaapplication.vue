<template>
  <div>
    ...
    <v-container fluid class="grid-list-xl py-0 mt-n3">
      <v-row>
        <app-card
          :heading="$t('message.visaApplication')"
          :fullBlock="true"
          ...
          >
            ...
            <template v-slot:item="row">
              <tr>
                ...
                <td>
                  <v-btn class="mx-2" dark small color="green">Details</v-btn>
                  <v-btn dark small color="dafault">Invoice</v-btn>
                  <!-- <v-btn
                    class="mx-2"
                    fab
                    dark
