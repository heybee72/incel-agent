...
const AddTourBookingTwo = () => import('Views/incel-admin/add.tourbooking.two');
const AddTourBookingAvailability = () => import('Views/incel-admin/add.tourbooking.availability');
...
export default {
  ...
  },
  {
    ...
    meta: {
      ...
      {
        breadcrumbActive: 'Add tour booking'
      }
      ]
    }
  },
  {
    path: '/admin/tourbookings/add/2',
    name: 'addBookingTwo',
    component: AddTourBookingTwo,
    props: true,
    meta: {
      requiresAuth: true,
      title: 'message.tourBookings',
      ...
      {
        breadcrumbActive: 'Continue tour booking'
      }
      ]
    }
  },
  {
    path: '/admin/tourbookings/add/availability',
    name: 'addBookingAvailability',
    component: AddTourBookingAvailability,
    props: true,
    meta: {
      requiresAuth: true,
      title: 'message.tourBookings',
      ...
      {
        breadcrumbActive: 'Get tour availability'
      }
      ]
    }
  },
